  ...
  return (
    <header className="site-header">
      ...
      <nav>
        ...
        <div className={`nav-dropdown more-dropdown ${openMenu === "more" ? "open" : ""}`} onMouseLeave={() => setOpenMenu(null)}><button className="dropdown-trigger" aria-expanded={openMenu === "more"} onClick={() => setOpenMenu((value) => value === "more" ? null : "more")}>More <Chevron /></button><div className="simple-dropdown"><button onClick={() => closeThen(() => onNavigate("resources"))}><span>▤</span><div><b>Resources</b><small>Study guides and ideas</small></div></button><button onClick={() => closeThen(() => onNavigate("faq"))}><span>?</span><div><b>FAQ</b><small>Common questions answered</small></div></button><button onClick={() => closeThen(() => onNavigate("contact"))}><span>✉</span><div><b>Contact</b><small>Talk with our team</small></div></button></div></div>
      </nav>
